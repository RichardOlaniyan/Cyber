...
no_of_characters = int(input("Length of password? \n"))
while no_of_characters <8:
    print("Minimum of 8 characters is needed for a strong password")
    no_of_characters = int(input("Length of password? \n"))
    if no_of_characters >= 8:
        break
...
if pwd_complexity == "a":
    ...
    pwd = "".join(secrets.choice(your_new_pwd) for i in range(no_of_characters))
    print("--------------------------********************------------------")    
    ...
    pwd = "".join(random.choice(your_new_pwd) for i in range(no_of_characters))
    print("--------------------------********************------------------")
